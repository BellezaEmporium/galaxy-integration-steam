...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_CPRODUCTIMPRESSIONSFROMCLIENT_NOTIFICATION_IMPRESSION'].fields_by_name['type']._options = None
  ...
  _globals['_CMOBILEDEVICE_REGISTERMOBILEDEVICE_REQUEST'].fields_by_name['mobile_app']._options = None
